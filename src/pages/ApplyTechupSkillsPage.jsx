              ...
              <div className='left'>
                ...
                <div className='radio-input'>
                  ...
                  <div className='option'>
                    ...
                    <div>
                      <label htmlFor='html'>18-25</label>
                    </div>
                  </div>
                  ...
                  <div className='option'>
                    ...
                    <div>
                      <label htmlFor='html'>25-30</label>
                    </div>
                  </div>
                </div>
                ...
                <div className='input'>
                  ...
                  <select name='cars' id='cars'>
                    ...
                    <option value='volvo'>Tanzania</option>
                    <option value='volvo'>Kenya</option>
                    <option value='volvo'>DRC</option>
                    <option value='volvo'>Uganda</option>
              ...
              <div className='right'>
                <div className='radio-input'>
                  ...
                  <div className='option'>
                    ...
                    <div>
                      <label htmlFor='html'>University Student</label>
                    </div>
                  </div>
              ...
              <div className='basicInfo'>
                <div className='left'>
                  <div className='radio-input'>
                    ...
                    {/* <h4>Which category do you fit in?</h4> */}
                    <div
                      className='option'
                      onClick={() => {
                        setCategory('entrepreneur');
              ...
              {category && category === 'talent' ? (
                <div className='software'>
                  ...
                  <div className='last'>
                      ...
                      <p>By Submitting your application, You hereby declare that the nformation provided is true and You must also understand any willful dishonesty will lead to disqualification.  </p></div>
